...
void parse_args(all_args_t* args, int argc, char* argv[])
{
  ...
  common.add_options()
    ...
    ("mme.security_setting",  bpo::value<bool>(&security_setting)->default_value(false),         "security_setting om/off")
  ...
  args->mme_args.s1ap_args.security_setting = security_setting;
